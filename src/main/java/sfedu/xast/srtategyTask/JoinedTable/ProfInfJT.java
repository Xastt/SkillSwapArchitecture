...
import sfedu.xast.srtategyTask.MappedSuperclass.PersInfMS;
...
public class ProfInfJT extends PersonJT{

    @ManyToOne
    @JoinColumn(name = "pers_id", nullable = false)
    private PersInfJT pers;
    ...
    public ProfInfJT(PersInfJT pers, String skillName, String skillDescription,
